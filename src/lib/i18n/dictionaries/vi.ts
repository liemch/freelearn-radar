...
export const vi: Dictionary = {
  ...
  trust: {
    ...
    activeCoupons: "coupon 100% đang hoạt động",
    activeCouponsHint: "Ưu đãi đã xác minh, còn hiệu lực trên Radar",
  },
  sections: {
    ...
    viewAll: "Xem tất cả",
    dailyFree: "Miễn phí hôm nay",
    dailyFreeSub: "Các khóa học đang có ưu đãi miễn phí được Radar xác minh.",
    ...
    browseDomains: "Khám phá theo lĩnh vực",
    browseDomainsSub: "Danh mục thật từ taxonomy Radar",
    providersOnRadar: "Nền tảng đang có khóa học trên Radar",
    providersOnRadarSub: "Các nguồn đang có khóa miễn phí đủ điều kiện trong catalog",
    needHelpTitle: "Không tìm thấy khóa học phù hợp?",
    needHelpDescription:
      "Thử tìm theo chủ đề, hoặc mở danh mục đầy đủ để lọc theo nền tảng và loại miễn phí.",
    needHelpAction: "Tìm khóa học",
  },
  interests: {
  ...
  courseDetail: {
    ...
    startFreeLearning: "Vào học miễn phí",
    claimFreeCourse: "Nhận khóa học miễn phí",
