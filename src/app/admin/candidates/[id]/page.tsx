      ...
      <main className="mx-auto max-w-4xl space-y-6 px-6 py-8">
        <section className="grid gap-4 rounded-xl border border-border p-5 sm:grid-cols-2">
          <div>
            ...
            <p className="font-medium">{candidate.discoveryStatus}</p>
          </div>
          <div>
        ...
        <section className="rounded-xl border border-border p-5">
          <h2 className="font-semibold">Deterministic classification</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Why FreeLearn Radar currently believes this about free/certificate
            status (text evidence, not AI alone).
          </p>
          <dl className="mt-4 grid gap-3 sm:grid-cols-2 text-sm">
            <div>
              <dt className="text-muted-foreground">Free status</dt>
              <dd className="font-medium">{free.priceType}</dd>
        ...
        <section className="rounded-xl border border-border p-5">
          <h2 className="font-semibold">Raw content</h2>
        ...
        <section className="rounded-xl border border-border p-5">
          <h2 className="font-semibold">AI analysis JSON</h2>
