...
export function SiteFooter({ locale }: SiteFooterProps) {
  ...
  return (
    <footer className="mt-auto border-t border-border/60 bg-surface pb-[env(safe-area-inset-bottom)]">
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-4 py-8 sm:px-6 sm:py-10 md:grid-cols-3">
